...
@interface ClendarUnit()<UICollectionViewDataSource,UICollectionViewDelegate>
...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        [self.collectionView registerClass:[ClendarDayUnit class] forCellWithReuseIdentifier:ClenderDay];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ClendarDayUnit *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ClenderDay forIndexPath:indexPath];
